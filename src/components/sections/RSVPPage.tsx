...
export const RSVPPage: React.FC<RSVPPageProps> = ({ isVisible }) => {
  ...
  return (
    <div id="rsvp-page" className="min-h-screen bg-[#F2E8C5] flex items-center justify-center p-8 animate-fadeIn relative">
      <div className="max-w-2xl w-full mx-auto text-center relative z-10 px-8">
        ...
        <AnimatedElement animationType="slide" delay={400}>
          <p
            className="text-[#504B38] text-base md:text-lg leading-relaxed mb-12 max-w-4xl mx-auto"
            style={{
          ...
          <AnimatedElement animationType="slide" delay={600}>
            <div className="text-left">
              <label
                ...
                style={{ fontFamily: 'var(--font-inter), system-ui, -apple-system, Segoe UI, Roboto, sans-serif' }}
              >
                Nama
              </label>
              <input
